...
with custom SSD1306 OLED, BME280 and OpenEth emulation. Compile Arduino sketches in your computer, upload binaries, and interact with a live digital twin — no physical board is required.
